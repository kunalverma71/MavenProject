...
<table class="table table-hover" id="api" class="display" border="2" width="80" align="center">
	...
	<c:forEach var="p" varStatus="st" items="${cartInfo}">
		<tr>
			...
			<td><i class="fa fa-inr"></i> <c:out value="${p.cartPrice }"></c:out></td>
			<td><img src="${pageContext.request.contextPath }/resources/${p.cartImage }" width="50px" height="50px"></td>
			<td><i class="fa fa-inr"> </i> <c:out value="${p.cartStock * p.cartPrice}"></c:out></td>		
			<td class="span4">
				<c:set var="contextRoot" value="${pageContext.request.contextPath }"></c:set>
				<a href="<c:url value="/deletePCart/${p.cartId}"/>" class="btn btn-danger" role="button">Delete</a>		
	...
	<span class="col-lg-9" align="right"><label>Grand Total </label> <i class="fa fa-inr"> </i> <c:out value="${gtot }"></c:out></span>
	</td>
